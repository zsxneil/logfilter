package com.zsxneil.logfilter.stater.converter;
...
public class SensitiveConverter extends MessageConverter {
    //手机号正则匹配
    public static  String PHONE_REGEX = "1[3|4|5|7|8][0-9]\\d{8}";
    //身份证号正则匹配 　　
    public static  String IDCARD_REGEX = "([1-9]\\d{5}(18|19|20)\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx])|(^[1-9]\\d{5}\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3})";
